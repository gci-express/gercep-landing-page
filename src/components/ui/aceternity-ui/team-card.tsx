            ...
            <AnimatePresence>
              {testimonials.map((testimonial, index) => (
                ...
                >
                  ...
                  <div
                    aria-hidden
                    className="absolute inset-0 flex items-end justify-center rounded-3xl bg-linear-to-t from-background/50 via-background/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                    role="presentation"
                  >
